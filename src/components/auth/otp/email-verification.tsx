...
import { EmailVerificationCheck } from "@components/auth/otp/email-verification-check";

type Props = {
  layout?: "modal" | "page";
};

const EmailVerification: React.FC<Props> = ({ layout = "modal" }) => {
  ...
  return (
    <div className="py-6 px-5 sm:p-8 bg-white mx-auto rounded-lg w-full sm:w-96 md:w-450px border border-gray-300">
      ...
      <EmailVerificationCheck onLoginSuccess={onLoginSuccess} />
